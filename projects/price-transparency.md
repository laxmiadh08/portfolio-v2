...
<p class="project-title">Healthcare Price Transparency Analysis</p>
...
The original hospital pricing files contained hundreds of thousands of records. For this analysis, the data was narrowed to 13 high-impact healthcare procedures spanning inpatient, outpatient, emergency, laboratory, and pharmacy services, resulting in a curated dataset of approximately 4,000 records optimized for cross-hospital price comparisons.
</p>
...
<div class="metric-card">
    <p>Average Negotiated Rate</p>
    <h3>$7,740</h3>
</div>

<div class="metric-card">
    <p>Median Negotiated Rate</p>
    <h3>$1,284</h3>
</div>

<div class="metric-card">
    <p>Average Cash Price</p>
    <h3>$22,605</h3>
</div>

<div class="metric-card">
    <p>Average Gross Charge</p>
    <h3>$30,794</h3>
</div>
...
<ul>
<li>MRI Brain (without contrast)</li>
<li>MRI Brain (with &amp; without contrast)</li>
...
<li>Emergency Room Visit - Level 4</li>
<li>Emergency Room Visit - Level 5</li>
...
<img src="/images/price-transparency/datamodel.jpg?raw=true"
...
<h3 class="text-bold">Hospital Price Comparison</h3>

<p>
Side-by-side comparison of negotiated rates across all three hospitals for common procedures. Total Knee Replacement was excluded because it disproportionately skewed the comparison.
</p>
